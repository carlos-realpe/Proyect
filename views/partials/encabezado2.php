  ...
  <header>
    ...
    <nav class="navbar navbar-expand-lg bg-light">
      <div class="container-fluid">
        <a class="navbar-brand" href="index.php">WORKANIMUS</a>
          ...
          <?php if (isset($_SESSION['login']) && $_SESSION['login'] == true) { ?>
            ...
            <div class="btn-group me-2">
              <a class="nav-link" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"
                style="bottom:10px; margin-right:10px;">
              ...
              <ul class="dropdown-menu fs-6" id="chatMenu1" aria-labelledby="dropdownMenuButton">
                <div>
            ...
            <li class="nav-item dropdown position-relative" style="bottom:12px; margin-right:10px;">
              <a class="nav-link" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"
                ...
                <span class="position-absolute top-10 start-105 translate-middle badge rounded-pill bg-danger"
                  id="contador"></span></a>
              <ul class="dropdown-menu" style="top: 50px;  right: 0px; left: auto;">
            ...
            <div style="margin-right:80px;">
              <ul class="navbar-nav">
                ...
                -->
                    ...
                    <div class="progress">
                      <div class="progress-bar" role="progressbar" style="width: <?php echo $_SESSION['porcentaje'] ?>%;"
                        aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"><?php echo $_SESSION['porcentaje'] . "%" ?>
                      </div>
                    </div>
                    <div>
                      <p style="font-size: 70%; color:gray; text-align:center;">Recomendacion</p>
                    </div>
                    ...
                    <a class="dropdown-item" href="index.php?c=Postulacion&a=postulacion">POSTULACIONES/PUBLICACIONES</a>
                    <a class="dropdown-item" href="index.php?c=Registro&a=generarOferta">GENERAR OFERTAS</a>
                    <a class="dropdown-item" href="index.php?c=Calificar&a=calificarMostrar">EMPLEADOS</a>
                    <a class="dropdown-item" href="index.php?c=Perfil&a=miPerfil">MI PERFIL</a>

                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="index.php?c=Login&a=cerrarSesion">CERRAR SESION</a>
            ...
            <?php } else { ?>
              ...
              <ul class="navbar-nav">
                <li>
                  <a class="nav-link" aria-current="page" href="index.php?c=Login&a=Login&p=login">Iniciar Sesion</a>
                </li>
