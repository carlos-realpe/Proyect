...
<section>
    ...
    <div class="seccion-perfil-usuario">
        <div class="contenedor-registroempleo">
            ...
            <div class="titulo-registroempleo">Editar Trabajo</div>

            <form
                action="index.php?c=Admin&a=EditarTrabajo&var=<?php echo $resultados["id_registro_trabajo"] ?>&var2=<?php echo $resultados["foto_trabajo"] ?>"
                class="form" id="form" method="post" enctype="multipart/form-data"
                onsubmit="return validargeneraroferta()">
                ...
                <div class="detalle-usuario">
                    <div class="input-img imagen">
                        <div class="perfil-usuario-avatar-generarem">
                            ...
                            <img src="<?php echo $resultados["foto_trabajo"] ?>" alt="foto de referencia al trabajo"
                    ...
                    <div class="input-box teximagen">
                          <div class="container text-center "><div class="row row-cols-3">
                   <div class="col-auto p-0">   <label for="detalle-titulo">Título</label></div>

  <div class="col-auto p-0 align-self-center"><button style="background-color: transparent; border: none;" class="d-inline-block" tabindex="0" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-content="El título debe precisar de manera específica la actividad a realizar." disabled> <span class="material-symbols-outlined">      info</span ></button></div> 
                        </div></div>
                        <div>
                        ...
                        <span class="lbl-titulo-of" id="lbl-det">*El detalle debe tener un máximo de 50 palabras.</span>
                    ...
                    <div class="detalle-campos dcizquierda">
                        <div class="input-box">
                            ...
                            <?php if ($resultados["cntd_tiempo"] == 0) {
                                $var = "none"; ?>
                             <div class="col-auto p-0 align-self-center">  <input type="checkbox" name="habilitar-time" id="habilitar-time" value="male"></div>
                            <?php } else {
                                $var = "block"; ?>
                             <div class="col-auto p-0 align-self-center">  <input type="checkbox" name="habilitar-time" id="habilitar-time" value="male" checked></div>
                            <?php } ?>
                            <!---------  --->
                      
                       
                       <div class="col-9 p-0"> <label for="habilitar-time">Habilitar el tiempo de duración del empleo</label></div>
                        <div class="col-auto p-0 align-self-center"><button style="background-color: transparent; border: none;" class="d-inline-block" tabindex="0" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-content="Habilitar tiempo, no hace énfasis en el tiempo de publicación." disabled> <span class="material-symbols-outlined">      info</span ></button></div> 
                        </div></div>
                            ...
                            <div class="col-md-auto">
                                <div class="container text-center ">
                                    <div class="row row-cols-2">
                                        ...
                                        <input type="number" id="quantity-numero" name="quantity-numero" min="1" max="10" style="width:100%"
                                            value="<?php echo $resultados["vacante"]; ?>" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="input-selec">
                            <div class="container text-center "><div class="row row-cols-2">
                       <div class="col-auto p-0">    <span class="">Seleccione el oficio</span></div>
    <div class="col-auto p-0 align-self-center"><button style="background-color: transparent; border: none;" class="d-inline-block" tabindex="0" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-content="Tiene que seleccionar el oficio referente al trabajo que se va a modificar." disabled> <span class="material-symbols-outlined">      info</span ></button></div> 
 </div></div>
                    ...
                    <div class="detalle-campos dcderecha">
                        <div class="input-box">
                            ...
                            <span class="lbl-titulo-of" id="lbl-lugar">No se admite carácter especiales</span>
                        ...
                        <span class="lbl-titulo-of" id="lbl-longitud">*Debe mover el punto en algún lugar de la
                            ...
                            <input type="hidden" id="idUser" name="idUser" value='<?php echo $resultados["idUser"] ?>'>
                ...
                <div class="button-guardado">
                    ...
                    <div class="button-gc-form"><input type="button"
                            onclick="location.href='index.php?c=Admin&a=ListaTrabajos'" value="Cancelar"></div>
                </div>
